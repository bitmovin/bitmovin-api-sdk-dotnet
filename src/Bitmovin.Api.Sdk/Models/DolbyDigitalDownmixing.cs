...
namespace Bitmovin.Api.Sdk.Models
{
    ...
    public class DolbyDigitalDownmixing
    {
        ...
        public DolbyDigitalCenterMixLevel? LoRoCenterMixLevel { get; set; }
        ...
        public DolbyDigitalCenterMixLevel? LtRtCenterMixLevel { get; set; }
        ...
        public DolbyDigitalSurroundMixLevel? LoRoSurroundMixLevel { get; set; }
        ...
        public DolbyDigitalSurroundMixLevel? LtRtSurroundMixLevel { get; set; }

        /// <summary>
        /// PreferredMode
        /// </summary>
        [JsonProperty(PropertyName = "preferredMode")]
        public DolbyDigitalDownmixingPreferredMode? PreferredMode { get; set; }
    }
}
