...
using Bitmovin.Api.Sdk.Analytics.Outputs.GcsServiceAccount.Customdata;

namespace Bitmovin.Api.Sdk.Analytics.Outputs.GcsServiceAccount
{
    /// <summary>
    /// API for GcsServiceAccountApi
    /// </summary>
    public class GcsServiceAccountApi
    {
        ...
        /// <summary>
        /// Initializes a new instance of the GcsServiceAccountApi class
        /// </summary>
        ...
        internal interface IGcsServiceAccountApiClient
        {
            ...
            [Get("/analytics/outputs/gcs-service-account/{output_id}")]
            [AllowAnyStatusCode]
