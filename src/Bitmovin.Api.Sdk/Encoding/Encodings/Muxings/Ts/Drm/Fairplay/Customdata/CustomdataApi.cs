...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Ts.Drm.Fairplay.Customdata
{
    public class CustomdataApi
    {
        ...
        /// <param name="muxingId">Id of the ts segment.</param>
        ...
        internal interface ICustomdataApiClient
        {
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/ts/{muxing_id}/drm/fairplay/{drm_id}/customData")]
            [AllowAnyStatusCode]
