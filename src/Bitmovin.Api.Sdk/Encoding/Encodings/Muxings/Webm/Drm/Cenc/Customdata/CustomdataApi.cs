...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Webm.Drm.Cenc.Customdata
{
    public class CustomdataApi
    {
        ...
        {
            [Get("/encoding/encodings/{encoding_id}/muxings/webm/{muxing_id}/drm/cenc/{drm_id}/customData")]
            [AllowAnyStatusCode]
