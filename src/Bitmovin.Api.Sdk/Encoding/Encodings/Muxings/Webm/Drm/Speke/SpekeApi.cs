...
using Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Webm.Drm.Speke.Customdata;

namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Webm.Drm.Speke
{
    /// <summary>
    /// API for SpekeApi
    /// </summary>
    public class SpekeApi
    {
        ...
        {
            [Post("/encoding/encodings/{encoding_id}/muxings/webm/{muxing_id}/drm/speke")]
            [AllowAnyStatusCode]
            ...
            [Delete("/encoding/encodings/{encoding_id}/muxings/webm/{muxing_id}/drm/speke/{drm_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/webm/{muxing_id}/drm/speke/{drm_id}")]
            [AllowAnyStatusCode]
