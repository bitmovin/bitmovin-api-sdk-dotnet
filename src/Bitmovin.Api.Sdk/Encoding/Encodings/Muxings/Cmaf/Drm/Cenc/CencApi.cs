...
using Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Cmaf.Drm.Cenc.Customdata;

namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Cmaf.Drm.Cenc
{
    public class CencApi
    {
        ...
        internal interface ICencApiClient
        {
            ...
            [Post("/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/cenc")]
            [AllowAnyStatusCode]
            ...
            [Delete("/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/cenc/{drm_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/cenc/{drm_id}")]
            [AllowAnyStatusCode]
            Task<Models.CencDrm> GetAsync([Path("encoding_id")] string encodingId, [Path("muxing_id")] string muxingId, [Path("drm_id")] string drmId);
            
            [Get("/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/cenc")]
            [AllowAnyStatusCode]
