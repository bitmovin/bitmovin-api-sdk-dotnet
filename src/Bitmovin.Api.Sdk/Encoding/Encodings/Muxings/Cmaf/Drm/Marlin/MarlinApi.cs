...
using Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Cmaf.Drm.Marlin.Customdata;

namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Cmaf.Drm.Marlin
{
    public class MarlinApi
    {
        ...
        internal interface IMarlinApiClient
        {
            ...
            [Post("/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/marlin")]
            [AllowAnyStatusCode]
            ...
            [Delete("/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/marlin/{drm_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/marlin/{drm_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/marlin")]
            [AllowAnyStatusCode]
