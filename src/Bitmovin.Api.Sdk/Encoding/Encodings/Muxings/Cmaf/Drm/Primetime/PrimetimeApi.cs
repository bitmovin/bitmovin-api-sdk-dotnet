...
using Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Cmaf.Drm.Primetime.Customdata;

namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Cmaf.Drm.Primetime
{
    public class PrimetimeApi
    {
        ...
        /// <summary>
        /// Delete PrimeTime DRM from CMAF
        /// </summary>
        /// <param name="encodingId">Id of the encoding.</param>
        /// <param name="muxingId">Id of the CMAF muxing</param>
        ...
        internal interface IPrimetimeApiClient
        {
            ...
            [Post("/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/primetime")]
            [AllowAnyStatusCode]
            ...
            [Delete("/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/primetime/{drm_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/primetime/{drm_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/primetime")]
            [AllowAnyStatusCode]
