...
using Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Cmaf.Drm.Playready.Customdata;

namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Cmaf.Drm.Playready
{
    public class PlayreadyApi
    {
        ...
        /// <summary>
        /// Delete PlayReady DRM from CMAF
        /// </summary>
        /// <param name="encodingId">Id of the encoding.</param>
        /// <param name="muxingId">Id of the CMAF muxing</param>
        ...
        internal interface IPlayreadyApiClient
        {
            ...
            [Post("/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/playready")]
            [AllowAnyStatusCode]
            ...
            [Delete("/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/playready/{drm_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/playready/{drm_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/playready")]
            [AllowAnyStatusCode]
