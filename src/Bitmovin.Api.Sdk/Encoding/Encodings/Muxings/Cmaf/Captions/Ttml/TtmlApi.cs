...
using Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Cmaf.Captions.Ttml.Customdata;
...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Cmaf.Captions.Ttml
{
    public class TtmlApi
    {
        ...
        internal interface ITtmlApiClient
        {
            ...
            [Post("/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/captions/ttml")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/captions/ttml")]
            [AllowAnyStatusCode]
