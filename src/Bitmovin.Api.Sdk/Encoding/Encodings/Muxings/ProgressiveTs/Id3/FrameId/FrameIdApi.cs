...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.ProgressiveTs.Id3.FrameId
{
    public class FrameIdApi
    {
        ...
        /// <param name="frameIdId3Tag">The request payload</param>
        ...
        internal interface IFrameIdApiClient
        {
            ...
            [AllowAnyStatusCode]
            Task<Models.PaginationResponse<Models.FrameIdId3Tag>> ListAsync([Path("encoding_id")] string encodingId, [Path("muxing_id")] string muxingId, [QueryMap] IDictionary<String, Object> queryParams);
