...
using Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.ProgressiveTs.Drm.Fairplay.Customdata;

namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.ProgressiveTs.Drm.Fairplay
{
    /// <summary>
    /// API for FairplayApi
    /// </summary>
    public class FairplayApi
    {
        ...
        /// <summary>
        /// Initializes a new instance of the FairplayApi class
        /// </summary>
        ...
        {
            [Post("/encoding/encodings/{encoding_id}/muxings/progressive-ts/{muxing_id}/drm/fairplay")]
            [AllowAnyStatusCode]
            ...
            [Delete("/encoding/encodings/{encoding_id}/muxings/progressive-ts/{muxing_id}/drm/fairplay/{drm_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/progressive-ts/{muxing_id}/drm/fairplay/{drm_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/progressive-ts/{muxing_id}/drm/fairplay")]
            [AllowAnyStatusCode]
