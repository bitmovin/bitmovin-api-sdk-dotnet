...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.ProgressiveTs.Drm.Aes.Customdata
{
    /// <summary>
    ...
    public class CustomdataApi
    {
        ...
        {
            [Get("/encoding/encodings/{encoding_id}/muxings/progressive-ts/{muxing_id}/drm/aes/{drm_id}/customData")]
            [AllowAnyStatusCode]
