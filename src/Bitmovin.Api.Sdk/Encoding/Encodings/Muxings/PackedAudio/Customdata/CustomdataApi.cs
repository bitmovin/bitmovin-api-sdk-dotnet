...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.PackedAudio.Customdata
{
    /// <summary>
    ...
    public class CustomdataApi
    {
        ...
        {
            [Get("/encoding/encodings/{encoding_id}/muxings/packed-audio/{muxing_id}/customData")]
            [AllowAnyStatusCode]
