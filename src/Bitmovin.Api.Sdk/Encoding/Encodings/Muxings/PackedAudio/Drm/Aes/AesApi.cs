...
using Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.PackedAudio.Drm.Aes.Customdata;

namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.PackedAudio.Drm.Aes
{
    /// <summary>
    /// API for AesApi
    /// </summary>
    public class AesApi
    {
        ...
        {
            [Post("/encoding/encodings/{encoding_id}/muxings/packed-audio/{muxing_id}/drm/aes")]
            [AllowAnyStatusCode]
            ...
            [Delete("/encoding/encodings/{encoding_id}/muxings/packed-audio/{muxing_id}/drm/aes/{drm_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/packed-audio/{muxing_id}/drm/aes/{drm_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/packed-audio/{muxing_id}/drm/aes")]
            [AllowAnyStatusCode]
