...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Fmp4.Drm.Marlin.Customdata
{
    /// <summary>
    ...
    public class CustomdataApi
    {
        ...
        {
            [Get("/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/drm/marlin/{drm_id}/customData")]
            [AllowAnyStatusCode]
