...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Fmp4.Drm.Clearkey
{
    ...
    public class ClearkeyApi
    {
        ...
        /// <summary>
        /// Initializes a new instance of the ClearkeyApi class
        /// </summary>
        ...
        internal interface IClearkeyApiClient
        {
            ...
            [AllowAnyStatusCode]
            Task<Models.PaginationResponse<Models.ClearKeyDrm>> ListAsync([Path("encoding_id")] string encodingId, [Path("muxing_id")] string muxingId, [QueryMap(SerializationMethod = QuerySerializationMethod.Serialized)] IDictionary<String, Object> queryParams);
        }
