...
using Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Fmp4.Captions.Webvtt.Customdata;

namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Fmp4.Captions.Webvtt
{
    public class WebvttApi
    {
        ...
        internal interface IWebvttApiClient
        {
            ...
            [Post("/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/captions/webvtt")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/captions/webvtt/{captions_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/captions/webvtt")]
            [AllowAnyStatusCode]
