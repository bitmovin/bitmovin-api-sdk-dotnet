...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Fmp4.Information
{
    /// <summary>
    ...
    public class InformationApi
    {
        ...
        public async Task<Models.Fmp4MuxingInformation> GetAsync(string encodingId, string muxingId)
        {
        ...
        {
            [Get("/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/information")]
            [AllowAnyStatusCode]
            Task<Models.Fmp4MuxingInformation> GetAsync([Path("encoding_id")] string encodingId, [Path("muxing_id")] string muxingId);
        }
    }
}
