...
using Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.ProgressiveWebm.Drm.Speke.Customdata;

namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.ProgressiveWebm.Drm.Speke
{
    /// <summary>
    /// API for SpekeApi
    /// </summary>
    public class SpekeApi
    {
        ...
        /// <summary>
        /// Initializes a new instance of the SpekeApi class
        /// </summary>
        ...
        {
            [Post("/encoding/encodings/{encoding_id}/muxings/progressive-webm/{muxing_id}/drm/speke")]
            [AllowAnyStatusCode]
            ...
            [Delete("/encoding/encodings/{encoding_id}/muxings/progressive-webm/{muxing_id}/drm/speke/{drm_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/progressive-webm/{muxing_id}/drm/speke/{drm_id}")]
            [AllowAnyStatusCode]
            Task<Models.SpekeDrm> GetAsync([Path("encoding_id")] string encodingId, [Path("muxing_id")] string muxingId, [Path("drm_id")] string drmId);

            [Get("/encoding/encodings/{encoding_id}/muxings/progressive-webm/{muxing_id}/drm/speke")]
            [AllowAnyStatusCode]
