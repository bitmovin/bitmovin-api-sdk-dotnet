...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.ProgressiveWebm.Customdata
{
    public class CustomdataApi
    {
        ...
        internal interface ICustomdataApiClient
        {
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/progressive-webm/{muxing_id}/customData")]
            [AllowAnyStatusCode]
