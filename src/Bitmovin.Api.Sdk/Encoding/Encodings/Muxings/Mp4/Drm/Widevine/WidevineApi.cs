...
using Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Mp4.Drm.Widevine.Customdata;
...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Mp4.Drm.Widevine
{
    public class WidevineApi
    {
        ...
        {
            [Post("/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/widevine")]
            [AllowAnyStatusCode]
            ...
            [Delete("/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/widevine/{drm_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/widevine/{drm_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/widevine")]
            [AllowAnyStatusCode]
