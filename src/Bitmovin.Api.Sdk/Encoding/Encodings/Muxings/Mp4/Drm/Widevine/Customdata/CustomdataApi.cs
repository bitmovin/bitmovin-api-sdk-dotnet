...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Mp4.Drm.Widevine.Customdata
{
    /// <summary>
    ...
    public class CustomdataApi
    {
        ...
        {
            [Get("/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/widevine/{drm_id}/customData")]
            [AllowAnyStatusCode]
