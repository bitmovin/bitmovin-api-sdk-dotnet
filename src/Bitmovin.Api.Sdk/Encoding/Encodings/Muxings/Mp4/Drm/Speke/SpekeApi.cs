...
using Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Mp4.Drm.Speke.Customdata;
...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.Muxings.Mp4.Drm.Speke
{
    ...
    public class SpekeApi
    {
        ...
        {
            [Post("/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/speke")]
            [AllowAnyStatusCode]
            ...
            [Delete("/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/speke/{drm_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/speke/{drm_id}")]
            [AllowAnyStatusCode]
            Task<Models.SpekeDrm> GetAsync([Path("encoding_id")] string encodingId, [Path("muxing_id")] string muxingId, [Path("drm_id")] string drmId);

            [Get("/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/speke")]
            [AllowAnyStatusCode]
