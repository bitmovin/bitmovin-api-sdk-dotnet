...
using Bitmovin.Api.Sdk.Encoding.Encodings.Subtitles.Dvbsub.Customdata;

namespace Bitmovin.Api.Sdk.Encoding.Encodings.Subtitles.Dvbsub
{
    public class DvbsubApi
    {
        ...
        internal interface IDvbsubApiClient
        {
            ...
            [Post("/encoding/encodings/{encoding_id}/subtitles/dvbsub")]
            [AllowAnyStatusCode]
