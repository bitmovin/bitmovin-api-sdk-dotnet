...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.Streams.Subtitles.Dvbsub.Customdata
{
    public class CustomdataApi
    {
        ...
        /// <summary>
        /// Subtitle DVB-SUB BurnIn Custom Data
        /// </summary>
        ...
        internal interface ICustomdataApiClient
        {
            ...
            [Get("/encoding/encodings/{encoding_id}/streams/{stream_id}/subtitles/dvbsub/{subtitle_id}/customData")]
            [AllowAnyStatusCode]
