...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.MachineLearning.ObjectDetection
{
    public class ObjectDetectionApi
    {
        ...
        internal interface IObjectDetectionApiClient
        {
            ...
            [AllowAnyStatusCode]
            Task<Models.PaginationResponse<Models.ObjectDetectionConfiguration>> ListAsync([Path("encoding_id")] string encodingId, [QueryMap(SerializationMethod = QuerySerializationMethod.Serialized)] IDictionary<String, Object> queryParams);
        }
