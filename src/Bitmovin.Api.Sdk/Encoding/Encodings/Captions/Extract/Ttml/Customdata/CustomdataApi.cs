...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.Captions.Extract.Ttml.Customdata
{
    public class CustomdataApi
    {
        ...
        internal interface ICustomdataApiClient
        {
            ...
            [Get("/encoding/encodings/{encoding_id}/captions/extract/ttml/{captions_id}/customData")]
            [AllowAnyStatusCode]
