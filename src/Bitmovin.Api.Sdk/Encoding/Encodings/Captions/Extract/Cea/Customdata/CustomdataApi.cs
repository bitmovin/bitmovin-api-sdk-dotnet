...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.Captions.Extract.Cea.Customdata
{
    public class CustomdataApi
    {
        ...
        internal interface ICustomdataApiClient
        {
            ...
            [Get("/encoding/encodings/{encoding_id}/captions/extract/cea/{captions_id}/customData")]
            [AllowAnyStatusCode]
