...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.InputStreams.Sidecar.DolbyVisionMetadataIngest
{
    public class DolbyVisionMetadataIngestApi
    {
        ...
        /// <param name="dolbyVisionMetadataIngestInputStream">The request payload</param>
        ...
        /// </summary>
        /// <param name="encodingId">Id of the encoding.</param>
        /// <param name="inputStreamId">Id of the Dolby Vision Metadata Ingest input stream.</param>
