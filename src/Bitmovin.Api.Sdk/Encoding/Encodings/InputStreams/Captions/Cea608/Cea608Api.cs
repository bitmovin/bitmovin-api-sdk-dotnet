...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.InputStreams.Captions.Cea608
{
    public class Cea608Api
    {
        ...
        /// <param name="cea608CaptionInputStream">The request payload</param>
        ...
        /// </summary>
        /// <param name="encodingId">Id of the encoding.</param>
        /// <param name="inputStreamId">Id of the CEA 608 input stream.</param>
        ...
        internal interface ICea608ApiClient
        {
            ...
            [AllowAnyStatusCode]
            Task<Models.PaginationResponse<Models.Cea608CaptionInputStream>> ListAsync([Path("encoding_id")] string encodingId, [QueryMap] IDictionary<String, Object> queryParams);
