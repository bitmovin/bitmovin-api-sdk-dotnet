...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.InputStreams.File
{
    public class FileApi
    {
        ...
        /// <param name="fileInputStream">The request payload</param>
        ...
        /// </summary>
        /// <param name="encodingId">Id of the encoding.</param>
        /// <param name="inputStreamId">Id of the File input stream.</param>
        ...
        internal interface IFileApiClient
        {
            ...
            [AllowAnyStatusCode]
            Task<Models.PaginationResponse<Models.FileInputStream>> ListAsync([Path("encoding_id")] string encodingId, [QueryMap] IDictionary<String, Object> queryParams);
