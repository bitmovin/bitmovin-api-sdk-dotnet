...
namespace Bitmovin.Api.Sdk.Encoding.Encodings.InputStreams.Trimming.TimeBased
{
    ...
    public class TimeBasedApi
    {
        ...
        /// <summary>
        /// Initializes a new instance of the TimeBasedApi class
        /// </summary>
        ...
        internal interface ITimeBasedApiClient
        {
            ...
            [AllowAnyStatusCode]
            Task<Models.PaginationResponse<Models.TimeBasedTrimmingInputStream>> ListAsync([Path("encoding_id")] string encodingId, [QueryMap(SerializationMethod = QuerySerializationMethod.Serialized)] IDictionary<String, Object> queryParams);
        }
