...
namespace Bitmovin.Api.Sdk.Encoding.Configurations.Audio.DolbyDigital.Customdata
{
    /// <summary>
    ...
    public class CustomdataApi
    {
        ...
        {
            [Get("/encoding/configurations/audio/dolby-digital/{configuration_id}/customData")]
            [AllowAnyStatusCode]
