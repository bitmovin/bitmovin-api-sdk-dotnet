...
namespace Bitmovin.Api.Sdk.Encoding.Configurations.Audio.DtsPassthrough.Customdata
{
    public class CustomdataApi
    {
        ...
        {
            [Get("/encoding/configurations/audio/dts-passthrough/{configuration_id}/customData")]
            [AllowAnyStatusCode]
