...
namespace Bitmovin.Api.Sdk.Encoding.Configurations.Audio.Eac3
{
    public class Eac3Api
    {
        ...
        /// </summary>
        /// <param name="eac3AudioConfiguration">The request payload</param>
        ...
        internal interface IEac3ApiClient
        {
            ...
            [AllowAnyStatusCode]
            Task<Models.PaginationResponse<Models.Eac3AudioConfiguration>> ListAsync([QueryMap] IDictionary<String, Object> queryParams);
