...
namespace Bitmovin.Api.Sdk.Encoding.Configurations.Audio.Mp3
{
    public class Mp3Api
    {
        ...
        /// </summary>
        /// <param name="mp3AudioConfiguration">The request payload</param>
        ...
        internal interface IMp3ApiClient
        {
            ...
            [AllowAnyStatusCode]
            Task<Models.PaginationResponse<Models.Mp3AudioConfiguration>> ListAsync([QueryMap] IDictionary<String, Object> queryParams);
