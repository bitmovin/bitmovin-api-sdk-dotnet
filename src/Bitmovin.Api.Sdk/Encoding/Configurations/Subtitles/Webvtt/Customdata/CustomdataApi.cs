...
namespace Bitmovin.Api.Sdk.Encoding.Configurations.Subtitles.Webvtt.Customdata
{
    /// <summary>
    ...
    public class CustomdataApi
    {
        ...
        {
            [Get("/encoding/configurations/subtitles/webvtt/{configuration_id}/customData")]
            [AllowAnyStatusCode]
