...
namespace Bitmovin.Api.Sdk.Encoding.Manifests.Hls.Streams.CustomTags
{
    ...
    public class CustomTagsApi
    {
        ...
        {
            [Post("/encoding/manifests/hls/{manifest_id}/streams/{stream_id}/custom-tags")]
            [AllowAnyStatusCode]
            ...
            [Delete("/encoding/manifests/hls/{manifest_id}/streams/{stream_id}/custom-tags/{custom_tag_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/manifests/hls/{manifest_id}/streams/{stream_id}/custom-tags/{custom_tag_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/manifests/hls/{manifest_id}/streams/{stream_id}/custom-tags")]
            [AllowAnyStatusCode]
            Task<Models.PaginationResponse<Models.CustomTag>> ListAsync([Path("manifest_id")] string manifestId, [Path("stream_id")] string streamId, [QueryMap(SerializationMethod = QuerySerializationMethod.Serialized)] IDictionary<String, Object> queryParams);
        }
