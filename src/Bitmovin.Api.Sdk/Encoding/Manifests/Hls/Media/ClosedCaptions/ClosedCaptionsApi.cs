...
namespace Bitmovin.Api.Sdk.Encoding.Manifests.Hls.Media.ClosedCaptions
{
    public class ClosedCaptionsApi
    {
        ...
        /// <param name="closedCaptionsMediaInfo">The request payload</param>
        ...
        /// </summary>
        /// <param name="manifestId">Id of the hls manifest.</param>
        /// <param name="mediaId">Id of the closed captions media.</param>
        ...
        internal interface IClosedCaptionsApiClient
        {
            ...
            [AllowAnyStatusCode]
            Task<Models.PaginationResponse<Models.ClosedCaptionsMediaInfo>> ListAsync([Path("manifest_id")] string manifestId, [QueryMap] IDictionary<String, Object> queryParams);
