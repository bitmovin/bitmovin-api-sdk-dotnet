...
namespace Bitmovin.Api.Sdk.Encoding.Manifests.Hls.Media.Audio
{
    public class AudioApi
    {
        ...
        /// <param name="audioMediaInfo">The request payload</param>
        ...
        internal interface IAudioApiClient
        {
            ...
            [AllowAnyStatusCode]
            Task<Models.PaginationResponse<Models.AudioMediaInfo>> ListAsync([Path("manifest_id")] string manifestId, [QueryMap] IDictionary<String, Object> queryParams);
