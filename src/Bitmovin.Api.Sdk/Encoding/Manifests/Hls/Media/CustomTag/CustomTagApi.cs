...
namespace Bitmovin.Api.Sdk.Encoding.Manifests.Hls.Media.CustomTag
{
    public class CustomTagApi
    {
        ...
        internal interface ICustomTagApiClient
        {
            ...
            [Post("/encoding/manifests/hls/{manifest_id}/media/{media_id}/custom-tag")]
            [AllowAnyStatusCode]
            ...
            [Delete("/encoding/manifests/hls/{manifest_id}/media/{media_id}/custom-tag/{custom_tag_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/manifests/hls/{manifest_id}/media/{media_id}/custom-tag/{custom_tag_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/manifests/hls/{manifest_id}/media/{media_id}/custom-tag")]
            [AllowAnyStatusCode]
