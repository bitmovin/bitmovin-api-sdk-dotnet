...
namespace Bitmovin.Api.Sdk.Encoding.Manifests.Dash.Periods.Adaptationsets.Video
{
    ...
    public class VideoApi
    {
        ...
        /// <param name="videoAdaptationSet">The video adaptation set to be added to the period</param>
        ...
        /// <param name="manifestId">Id of the manifest (required)</param>
        /// <param name="periodId">Id of the period (required)</param>
        /// <param name="adaptationsetId">Id of the video adaptation set to be deleted (required)</param>
        ...
        /// <param name="manifestId">Id of the manifest (required)</param>
        /// <param name="periodId">Id of the period (required)</param>
        /// <param name="adaptationsetId">Id of the video adaptation set (required)</param>
