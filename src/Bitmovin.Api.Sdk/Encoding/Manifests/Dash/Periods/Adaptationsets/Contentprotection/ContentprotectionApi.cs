...
namespace Bitmovin.Api.Sdk.Encoding.Manifests.Dash.Periods.Adaptationsets.Contentprotection
{
    public class ContentprotectionApi
    {
        ...
        /// <param name="periodId">Id of the period</param>
        /// <param name="adaptationsetId">Id of the adaptation set</param>
        /// <param name="contentprotectionId">Id of the adaptation set content protection to be deleted</param>
        ...
        /// <param name="periodId">Id of the period</param>
        /// <param name="adaptationsetId">Id of the adaptation set</param>
        /// <param name="contentprotectionId">Id of the adaptation set content protection</param>
