...
namespace Bitmovin.Api.Sdk.Encoding.Manifests.Dash.Periods.Adaptationsets.Representations.Webm.Contentprotection
{
    public class ContentprotectionApi
    {
        ...
        /// <param name="adaptationsetId">Id of the adaptation set</param>
        /// <param name="representationId">Id of the representation</param>
        /// <param name="contentprotectionId">Id of the DRM WebM content protection to be deleted</param>
        ...
        /// <param name="adaptationsetId">Id of the adaptation set</param>
        /// <param name="representationId">Id of the representation</param>
        /// <param name="contentprotectionId">Id of the DRM WebM content protection</param>
