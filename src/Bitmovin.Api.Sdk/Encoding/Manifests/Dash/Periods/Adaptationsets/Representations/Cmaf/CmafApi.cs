...
namespace Bitmovin.Api.Sdk.Encoding.Manifests.Dash.Periods.Adaptationsets.Representations.Cmaf
{
    public class CmafApi
    {
        ...
        /// <param name="dashCmafRepresentation">The CMAF representation to be added to the adaptation set</param>
        ...
        /// <param name="periodId">Id of the period (required)</param>
        /// <param name="adaptationsetId">Id of the adaptation set (required)</param>
        /// <param name="representationId">Id of the CMAF representation to be deleted (required)</param>
