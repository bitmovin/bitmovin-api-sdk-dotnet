...
namespace Bitmovin.Api.Sdk.Encoding.Manifests.Dash.Periods.Adaptationsets.Representations.Cmaf.Contentprotection
{
    ...
    public class ContentprotectionApi
    {
        ...
        /// <param name="contentProtection">The content protection to be added to the CMAF representation</param>
        ...
        /// <param name="adaptationsetId">Id of the adaptation set (required)</param>
        /// <param name="representationId">Id of the representation (required)</param>
        /// <param name="contentprotectionId">Id of the DRM CMAF content protection to be deleted (required)</param>
        ...
        /// <param name="adaptationsetId">Id of the adaptation set (required)</param>
        /// <param name="representationId">Id of the representation (required)</param>
        /// <param name="contentprotectionId">Id of the DRM CMAF content protection (required)</param>
