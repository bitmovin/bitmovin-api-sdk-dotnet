...
namespace Bitmovin.Api.Sdk.Encoding.Manifests.Dash.Periods.Adaptationsets.Representations.Cmaf.Drm.Contentprotection
{
    public class ContentprotectionApi
    {
        ...
        /// <summary>
        /// Add Content Protection to DRM CMAF Representation
        /// </summary>
        ...
        /// <summary>
        /// Delete DRM CMAF Representation Content Protection
        /// </summary>
        /// <param name="manifestId">Id of the manifest</param>
        /// <param name="periodId">Id of the period</param>
        /// <param name="adaptationsetId">Id of the adaptation set</param>
        ...
        /// <summary>
        /// DRM CMAF Representation Content Protection Details
        /// </summary>
        /// <param name="manifestId">Id of the manifest</param>
        /// <param name="periodId">Id of the period</param>
        /// <param name="adaptationsetId">Id of the adaptation set</param>
        ...
        /// <summary>
        /// List all DRM CMAF Representation Content Protections
        /// </summary>
        /// <param name="manifestId">Id of the manifest</param>
        /// <param name="periodId">Id of the period</param>
        /// <param name="adaptationsetId">Id of the adaptation set</param>
        ...
        internal interface IContentprotectionApiClient
        {
            ...
            [Post("/encoding/manifests/dash/{manifest_id}/periods/{period_id}/adaptationsets/{adaptationset_id}/representations/cmaf/drm/{representation_id}/contentprotection")]
            [AllowAnyStatusCode]
            ...
            [Delete("/encoding/manifests/dash/{manifest_id}/periods/{period_id}/adaptationsets/{adaptationset_id}/representations/cmaf/drm/{representation_id}/contentprotection/{contentprotection_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/manifests/dash/{manifest_id}/periods/{period_id}/adaptationsets/{adaptationset_id}/representations/cmaf/drm/{representation_id}/contentprotection/{contentprotection_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/manifests/dash/{manifest_id}/periods/{period_id}/adaptationsets/{adaptationset_id}/representations/cmaf/drm/{representation_id}/contentprotection")]
            [AllowAnyStatusCode]
