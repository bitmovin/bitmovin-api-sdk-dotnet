...
namespace Bitmovin.Api.Sdk.Encoding.Manifests.Dash.Periods.Adaptationsets.Representations.Mp4.Drm
{
    public class DrmApi
    {
        ...
        /// <param name="dashMp4DrmRepresentation">The DRM MP4 representation to be added to the adaptation set</param>
        ...
        /// <param name="periodId">Id of the period (required)</param>
        /// <param name="adaptationsetId">Id of the adaptation set (required)</param>
        /// <param name="representationId">Id of the DRM MP4 representation to be deleted (required)</param>
