...
namespace Bitmovin.Api.Sdk.Encoding.Manifests.Dash.Periods.Adaptationsets.Representations.Fmp4.Drm.Contentprotection
{
    public class ContentprotectionApi
    {
        ...
        /// <param name="adaptationsetId">Id of the adaptation set</param>
        /// <param name="representationId">Id of the representation</param>
        /// <param name="contentprotectionId">Id of the DRM fMP4 content protection to be deleted</param>
        ...
        /// <param name="adaptationsetId">Id of the adaptation set</param>
        /// <param name="representationId">Id of the representation</param>
        /// <param name="contentprotectionId">Id of the DRM fMP4 content protection</param>
        ...
        internal interface IContentprotectionApiClient
        {
            ...
            [Post("/encoding/manifests/dash/{manifest_id}/periods/{period_id}/adaptationsets/{adaptationset_id}/representations/fmp4/drm/{representation_id}/contentprotection")]
            [AllowAnyStatusCode]
            ...
            [Delete("/encoding/manifests/dash/{manifest_id}/periods/{period_id}/adaptationsets/{adaptationset_id}/representations/fmp4/drm/{representation_id}/contentprotection/{contentprotection_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/manifests/dash/{manifest_id}/periods/{period_id}/adaptationsets/{adaptationset_id}/representations/fmp4/drm/{representation_id}/contentprotection/{contentprotection_id}")]
            [AllowAnyStatusCode]
            ...
            [Get("/encoding/manifests/dash/{manifest_id}/periods/{period_id}/adaptationsets/{adaptationset_id}/representations/fmp4/drm/{representation_id}/contentprotection")]
            [AllowAnyStatusCode]
