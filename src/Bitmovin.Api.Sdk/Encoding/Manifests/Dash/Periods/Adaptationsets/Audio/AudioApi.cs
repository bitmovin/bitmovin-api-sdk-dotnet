...
namespace Bitmovin.Api.Sdk.Encoding.Manifests.Dash.Periods.Adaptationsets.Audio
{
    public class AudioApi
    {
        ...
        /// <param name="audioAdaptationSet">The audio adaptation set to be added to the period</param>
        ...
        /// <param name="manifestId">Id of the manifest (required)</param>
        /// <param name="periodId">Id of the period (required)</param>
        /// <param name="adaptationsetId">Id of the audio adaptation set (required)</param>
