...
namespace Bitmovin.Api.Sdk.Encoding.Statistics
{
    public class StatisticsApi
    {
        ...
        internal interface IStatisticsApiClient
        {
            ...
            [AllowAnyStatusCode]
            Task<Models.PaginationResponse<Models.Statistics>> ListAsync([Path("from", Format = "o")] DateTime? from, [Path("to", Format = "o")] DateTime? to, [QueryMap] IDictionary<String, Object> queryParams);
