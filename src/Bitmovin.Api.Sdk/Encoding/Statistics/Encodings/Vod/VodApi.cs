...
namespace Bitmovin.Api.Sdk.Encoding.Statistics.Encodings.Vod
{
    public class VodApi
    {
        ...
        internal interface IVodApiClient
        {
            ...
            [AllowAnyStatusCode]
            Task<Models.PaginationResponse<Models.EncodingStatisticsVod>> ListByDateRangeAsync([Path("from", Format = "o")] DateTime? from, [Path("to", Format = "o")] DateTime? to, [QueryMap] IDictionary<String, Object> queryParams);
