...
namespace Bitmovin.Api.Sdk.Encoding.Statistics.Encodings.Live
{
    public class LiveApi
    {
        ...
        internal interface ILiveApiClient
        {
            ...
            [AllowAnyStatusCode]
            Task<Models.PaginationResponse<Models.EncodingStatisticsLive>> ListByDateRangeAsync([Path("from", Format = "o")] DateTime? from, [Path("to", Format = "o")] DateTime? to, [QueryMap] IDictionary<String, Object> queryParams);
