...
namespace Bitmovin.Api.Sdk.Encoding.Statistics.Labels.Daily
{
    public class DailyApi
    {
        ...
        internal interface IDailyApiClient
        {
            ...
            [AllowAnyStatusCode]
            Task<Models.PaginationResponse<Models.DailyStatisticsPerLabel>> ListByDateRangeAsync([Path("from", Format = "o")] DateTime? from, [Path("to", Format = "o")] DateTime? to, [QueryMap] IDictionary<String, Object> queryParams);
