...
namespace Bitmovin.Api.Sdk.Encoding.Outputs.Azure
{
    public class AzureApi
    {
        ...
        /// Create Azure Output
        /// </summary>
        /// <param name="azureOutput">The request payload</param>
        ...
        internal interface IAzureApiClient
        {
            ...
            [AllowAnyStatusCode]
            Task<Models.PaginationResponse<Models.AzureOutput>> ListAsync([QueryMap] IDictionary<String, Object> queryParams);
