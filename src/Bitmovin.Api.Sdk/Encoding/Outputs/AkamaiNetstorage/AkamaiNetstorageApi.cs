...
namespace Bitmovin.Api.Sdk.Encoding.Outputs.AkamaiNetstorage
{
    ...
    public class AkamaiNetstorageApi
    {
        ...
        /// <summary>
        /// Initializes a new instance of the AkamaiNetstorageApi class
        /// </summary>
        ...
        /// </summary>
        /// <param name="akamaiNetStorageOutput">The Akamai NetStorage output to be created</param>
        ...
        internal interface IAkamaiNetstorageApiClient
        {
            ...
            [AllowAnyStatusCode]
            Task<Models.PaginationResponse<Models.AkamaiNetStorageOutput>> ListAsync([QueryMap(SerializationMethod = QuerySerializationMethod.Serialized)] IDictionary<String, Object> queryParams);
        }
