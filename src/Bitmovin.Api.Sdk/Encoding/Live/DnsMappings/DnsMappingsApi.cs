...
namespace Bitmovin.Api.Sdk.Encoding.Live.DnsMappings
{
    /// <summary>
    ...
    public class DnsMappingsApi
    {
        ...
        public async Task<Models.PaginationResponse<Models.DnsMappingResponse>> ListAsync(params Func<ListQueryParams, ListQueryParams>[] queryParams)
        {
        ...
        {
            [Get("/encoding/live/dns-mappings")]
            [AllowAnyStatusCode]
            Task<Models.PaginationResponse<Models.DnsMappingResponse>> ListAsync([QueryMap(SerializationMethod = QuerySerializationMethod.Serialized)] IDictionary<String, Object> queryParams);
        }
