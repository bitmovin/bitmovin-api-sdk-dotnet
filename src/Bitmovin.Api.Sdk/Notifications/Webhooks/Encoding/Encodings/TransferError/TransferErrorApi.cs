...
namespace Bitmovin.Api.Sdk.Notifications.Webhooks.Encoding.Encodings.TransferError
{
    ...
    public class TransferErrorApi
    {
        ...
        /// <summary>
        /// Initializes a new instance of the TransferErrorApi class
        /// </summary>
        ...
        /// </summary>
        /// <param name="webhook">The &#39;Encoding Transfer Error&#39; Webhook to be added.</param>
        ...
        /// <param name="webhook">The &#39;Encoding Transfer Error&#39; Webhook to be added. A maximum number of 5 webhooks per Encoding is allowed</param>
