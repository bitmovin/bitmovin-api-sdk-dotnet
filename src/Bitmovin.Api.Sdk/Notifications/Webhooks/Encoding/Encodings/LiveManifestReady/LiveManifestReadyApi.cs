...
using Bitmovin.Api.Sdk.Notifications.Webhooks.Encoding.Encodings.LiveManifestReady.Customdata;

namespace Bitmovin.Api.Sdk.Notifications.Webhooks.Encoding.Encodings.LiveManifestReady
{
    /// <summary>
    /// API for LiveManifestReadyApi
    /// </summary>
    public class LiveManifestReadyApi
    {
        private readonly ILiveManifestReadyApiClient _apiClient;

        /// <summary>
        /// Initializes a new instance of the LiveManifestReadyApi class
        /// </summary>
        /// <param name="apiClientFactory">The API client factory</param>
        public LiveManifestReadyApi(IBitmovinApiClientFactory apiClientFactory)
        {
            _apiClient = apiClientFactory.CreateClient<ILiveManifestReadyApiClient>();
        ...
        /// </summary>
        public static BitmovinApiBuilder<LiveManifestReadyApi> Builder => new BitmovinApiBuilder<LiveManifestReadyApi>();
        ...
        /// </summary>
        /// <param name="webhook">The &#39;Live Manifest Ready&#39; Webhook to be added.</param>
        ...
        internal interface ILiveManifestReadyApiClient
        {
            [Post("/notifications/webhooks/encoding/encodings/live-manifest-ready")]
            [AllowAnyStatusCode]
            Task<Models.Webhook> CreateAsync([Body] Models.Webhook webhook);

            [Post("/notifications/webhooks/encoding/encodings/{encoding_id}/live-manifest-ready")]
            [AllowAnyStatusCode]
            Task<Models.Webhook> CreateByEncodingIdAsync([Path("encoding_id")] string encodingId, [Body] Models.Webhook webhook);

            [Delete("/notifications/webhooks/encoding/encodings/{encoding_id}/live-manifest-ready/{webhook_id}")]
            [AllowAnyStatusCode]
            ...
            [Delete("/notifications/webhooks/encoding/encodings/live-manifest-ready/{webhook_id}")]
            [AllowAnyStatusCode]
            Task<Models.BitmovinResponse> DeleteByWebhookIdAsync([Path("webhook_id")] string webhookId);

            [Get("/notifications/webhooks/encoding/encodings/{encoding_id}/live-manifest-ready/{webhook_id}")]
            [AllowAnyStatusCode]
            Task<Models.Webhook> GetByEncodingIdAndWebhookIdAsync([Path("encoding_id")] string encodingId, [Path("webhook_id")] string webhookId);

            [Get("/notifications/webhooks/encoding/encodings/live-manifest-ready/{webhook_id}")]
            [AllowAnyStatusCode]
            Task<Models.Webhook> GetByWebhookIdAsync([Path("webhook_id")] string webhookId);

            [Get("/notifications/webhooks/encoding/encodings/live-manifest-ready")]
            [AllowAnyStatusCode]
            ...
            [Get("/notifications/webhooks/encoding/encodings/{encoding_id}/live-manifest-ready")]
            [AllowAnyStatusCode]
